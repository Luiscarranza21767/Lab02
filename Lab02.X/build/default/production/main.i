...
# 2914 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\proc\\pic16f887.inc" 1 3
# 48 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\proc\\pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2819 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\proc\\pic16f887.inc" 3
...
# 2914 "C:\\Program Files\\Microchip\\xc8\\v2.40\\pic\\include\\pic_as_chip_select.inc" 2 3
...
; CONFIG1
  ...
  CONFIG WDTE = OFF ; Watchdog Timer Enable bit (WDT disabled and
    ; can be enabled by ((WDTCON) and 07Fh), 0 bit of the WDTCON
    ; register)
  CONFIG PWRTE = OFF ; Power-up Timer Enable bit (PWRT disabled)
  CONFIG MCLRE = OFF ; ((PORTE) and 07Fh), 3/MCLR pin function select bit (((PORTE) and 07Fh), 3/MCLR
  ...
  CONFIG LVP = OFF ; Low Voltage Programming Enable bit (((PORTB) and 07Fh), 3 pin
...
BANKSEL OPTION_REG
    BCF OPTION_REG, 5 ; ((OPTION_REG) and 07Fh), 5 COMO FOSC/4
...
LOOP:
    ...
    BTFSC PORTA, 0 ; Revisa si se presionó ((PORTA) and 07Fh), 1
    CALL Antirrebote1
    BTFSS PORTA, 0
    CALL Incremento
    BTFSC PORTA, 1 ; Revisa si se presionó ((PORTA) and 07Fh), 1
    CALL Antirrebote2
    BTFSS PORTA, 1
    CALL Decremento
